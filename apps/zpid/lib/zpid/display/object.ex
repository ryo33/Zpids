defmodule Zpid.Display.Object do
  use GenServer
  ...
  defmacro __using__(_opts) do
    quote do
      @behaviour Zpid.Display.Object
      import Zpid.Display.Object, only: [defobject: 1]
    end
  end
  ...
  defmacro defobject(definition) do
    quote do
      ...
      case ExJsonSchema.Validator.validate(Zpid.Display.Object.schema, json) do
        {:error, x} ->
          raise inspect x
        _ -> :ok
      end
